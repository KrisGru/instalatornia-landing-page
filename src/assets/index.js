...
class Slider extends React.PureComponent {
  ...
  handleTouchStart = (e) => {
    ...
    const touchDelta =
      this.currentElement.getBoundingClientRect()[this.swipeProperty];
...
Slider.propTypes = {
  ...
  onSlideChange: PropTypes.string,
  infinite: PropTypes.string,
  duration: PropTypes.string,
  disabled: PropTypes.string,
  minSwipeOffset: PropTypes.string,
  classNames: PropTypes.string,
  className: PropTypes.string,
  previousButton: PropTypes.string,
  nextButton: PropTypes.any,
  touchDisabled: PropTypes.any,
};

Arrow.propTypes = {
  direction: PropTypes.string,
  previousButton: PropTypes.any,
};
